...
BRACKET_FOOT_X_MM = (-62.0, -8.0)
BRACKET_FOOT_Y_MM = (4.0, 10.0)
BRACKET_PLATE_Y_MM = (8.0, 60.0)
BRACKET_Z_MM = (-58.0, 58.0)
BASEPLATE_THICKNESS_MM = 4.0
BASE_M3_TAPPED_DIAMETER_MM = 2.5
BASE_M3_SCREW_LENGTH_MM = 10.0
BASE_M3_THREAD_ENGAGEMENT_MM = 6.0
MOTOR_M3_SCREW_LENGTH_MM = 10.0
MOTOR_M3_THREAD_ENGAGEMENT_MM = 6.0
DIRECT_OUTPUT_M4_SCREW_LENGTH_MM = 8.0
OFFSET_OUTPUT_M4_SCREW_LENGTH_MM = 14.0
